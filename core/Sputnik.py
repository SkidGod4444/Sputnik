...
class Sputnik(commands.AutoShardedBot):
    ...
    async def on_connect(self):
      await self.change_presence(status=discord.Status.online)#activity=discord.Activity(type=discord.ActivityType.Listening, name=f'.help'))
